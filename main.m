...
gripping_point = 0.176;

L(1) = Revolute('d',0.2357,'a',0,'alpha',-pi/2);
...
T = transl(X1,Y1, Z1) * trotx(180 * pi/180);
%qi1 = robot.ikine(T, 'mask', [1 1 1 0 0 0]); % added ('mask', [1 1 1 0 0 0]) since 'rejected-step limit 100 exceeded'
qi1 = inverseKinematicsCalculator(T)
...
T = transl(X2, -Y2, Z2) * trotx(180* pi/180);
qi1 = robot.ikine(T,  'mask', [1 1 1 0 0 0]);
qf1 = [0 -pi/2 0 0 -pi/2 pi/2];
q = jtraj(qf1,qi1,t);
% robot.plot(q);
